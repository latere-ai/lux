...
- This repository is public. No Latere hostname, token, or internal reference anywhere but as a default or an example. A platform that builds on it lives elsewhere and is one consumer among any. Nothing in this repository names any particular deployment of Lux.
