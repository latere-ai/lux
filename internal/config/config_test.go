...
func TestLoadAppliesEveryDefault(t *testing.T) {
	...
	want := Config{
		...
		CatalogReload: DefaultCatalogReload, KeyCacheGrace: DefaultKeyCacheGrace,
		PublicURL: wantPublicURL(t), BasePathMode: BasePathPrefix, RequestsPerMinute: 600, UnauthenticatedRequestsPerMinute: 60,
...
func TestLoadReadsEveryVariable(t *testing.T) {
	...
	c, err := Load(env(map[string]string{
		...
		"LUX_KEY_CACHE":                           "30s",
		"LUX_KEY_CACHE_GRACE":                     "0s",
		"LUX_CATALOG_RELOAD":                      "1m",
