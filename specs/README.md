...
| [012](012-request-log-and-events.md) | Request log and events: one signed event per mutation to the operator's sink, one record per request to an archive | small | dispatched | 006, 009, 010 |
...
| [018](018-conformance-suite.md) | Conformance suite: the contract, the doors, and the API as executable tests, against any server | large | in-progress | 003, 004, 011 |
| [019](019-observability.md) | Observability: metrics, traces, logs, alerts | small | dispatched | 002, 004, 009 |
