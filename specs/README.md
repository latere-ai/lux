...
| [004](004-request-path.md) | Request path: the dialect doors, route classes, the pipeline, translation, streaming, the data plane errors | large | in-progress | 001, 003 |
| [005](005-providers.md) | Providers: dialects, credential custody, discovery, health, the upstream client | medium | dispatched | 001, 003, 010 |
