...
| [006](006-identity.md) | Identity: OIDC issuers, subjects, the authorizer webhook, the owner policy | medium | testing | 001, 002, 003 |
...
| [010](010-state.md) | State: desired and observed, the store contract, memory, Postgres, the file mode | large | dispatched | 003 |
