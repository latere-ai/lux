...
| [036](036-catalog-in-memory.md) | The catalog in memory: Models, Providers, and sealed credentials served from a per-replica snapshot, and serving through a store outage | medium | in-progress | 004, 005, 007, 009, 010, 012, 019 |
...
- Acceptance criteria are one-sentence testable statements that name
  the behavior, the fixture, the threshold, and the test that proves
  them.
