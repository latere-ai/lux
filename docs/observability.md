...
| `LuxCatalogStale` | a replica's in-memory catalog has not matched the store for 90s, held 5m |
| `LuxKeyCacheServingStale` | a replica is serving cached Keys past their window because the store does not answer |
